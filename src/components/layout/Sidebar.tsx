...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 w-64 flex flex-col bg-gray-900 dark:bg-gray-950 border-r border-gray-800">
      {/* Logo */}
      <div className="flex h-16 items-center gap-2 px-6 border-b border-gray-800">
        ...
        <span className="text-lg font-bold text-white">ecom-dash</span>
      </div>
