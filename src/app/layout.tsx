...
export const metadata: Metadata = {
  title: "ecom-dash — E-commerce Analytics Dashboard",
  description:
    "Real-time analytics dashboard for e-commerce businesses with sales tracking, order management, and product insights.",
};
